...
<section class="relative w-full min-h-screen flex flex-col items-center justify-center text-black bg-[#E9E9E9] px-4 sm:px-24 py-8">
...
<p class="text-center sm:text-left text-xl xl:text-2xl 2xl:text-3xl sm:w-7/12">
Comunicado CUFRISA 9 de noviembre 2023. Pagina web que suplanta nuestro nombre. (pdf)
  </p>
  <a href="/" class="bg-[#263650] w-11/12 sm:w-3/12 text-center text-white text-xl xl:text-2xl 2xl:text-3xl py-4 2xl:py-6 rounded shadow-md hover:bg-blue-600 transition-colors duration-300">
  <div class="">
