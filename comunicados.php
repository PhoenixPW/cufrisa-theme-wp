...
<img src="<?php echo get_template_directory_uri(); ?>/public/logo.webp" loading="lazy" alt="Logo" class="w-4/12 sm:hidden" />
...
<a href="<?php echo get_template_directory_uri(); ?>/assets/pdf/" target="_blank" class="flex sm:flex-row justify-center sm:items-center  bg-[#263650] w-11/12 sm:w-4/12 xl:w-3/12 text-center text-white text-xl sm:text-sm md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl py-4 2xl:py-6 rounded shadow-md hover:bg-blue-600 transition-colors duration-300">

 Descargar
 <img src="<?php echo get_template_directory_uri(); ?>/public/descargas.svg" loading="lazy" alt="Icono descargar" class="ml-2 sm:w-[17px] md:w-[20px] lg:w-[24px] xl:w-[30px] 2xl:w-[33px]"/>
