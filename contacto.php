...
<section id="hero" class="relative w-full min-h-screen bg-cover bg-center bg-black text-white flex items-center justify-left" style={{ backgroundImage: "url('./Contacto.png')" }}>
<div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center sm:justify-start sm:px-12 sm:pt-16 sm:pl-20 ">

  <div class=" flex-col gap-3 2xl:gap-5 text-left sm:w-7/12 break-words ">
   <h1 class="sm:hidden text-5xl font-bold">Contacto</h1>
   <h1 class="hidden sm:block text-4xl 2xl:text-6xl font-bold mb-4 tracking-wider">
    Hagamos un trato

    </h1>
    
    <div class="hidden sm:block">
    <p class="text-xl 2xl:text-3xl font-light w-7/12 leading-6">
...
<br/>
    ...
    <ul class="text-lg 2xl:text-2xl font-light mt-2 flex flex-col gap-5 mb-6">
      <li class="flex gap-6 items-center">
        <div class="w-10 h-10 bg-white rounded-full">
        </div>
        <p class="w-7/12 leading-6">
Calle 15 Sur 502 A, 72764 Colonia Plazuelas de Zerezotla, San Pedro Cholula, Puebla, Mexico
    ...
    <a class="flex bg-white text-black rounded py-2 w-4/12 justify-center">
      <span>
        <i></i>
        Envíanos un mensaje
      </span>
  ...
  <form class="hidden sm:flex flex-col bg-white w-5/12 rounded-2xl text-lg 2xl:text-2xl p-10 2xl:p-12  gap-7 2xl:gap-9">
...
<section class="relative w-full min-h-screen md:h-screen flex flex-col items-center justify-center text-black bg-[#E9E9E9] gap-8 px-5 sm:px-40 py-10">
...
Teléfono
  ...
  <h2 class="text-[#1D3750] text-3xl xl:text-4xl 2xl:text-6xl font-extrabold sm:font-bold tracking-wider sm:mb-5">¡VEN A VISITARNOS!</h2>
  <p class="text-xl xl:text-2xl 2xl:text-4xl xllw-7/12 2xl:w-8/12 text-center tracking-normal">
