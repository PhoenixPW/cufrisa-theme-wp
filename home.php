...
<section class="flex flex-wrap">
      ...
      <section class="mb-12 sm:mb-0">
       ...
       <h3 class="font-bold text-2xl lg:text-lg xl:text-lg 2xl:text-2xl text-gray-600 text-center">
       ...
       <div class="mt-6">
        <ul class="flex flex-col sm:flex-row gap-x-10 gap-y-6 flex-wrap items-center justify-center md:gap-x-10">
          ...
          <div class="bg-black w-20 sm:w-16 2xl:w-20 h-20 sm:h-16 2xl:h-20 rounded-lg"></div>
          <div class="bg-black w-20 sm:w-16 2xl:w-20 h-20 sm:h-16 2xl:h-20 rounded-lg"></div>
          <div class="bg-black w-20 sm:w-16 2xl:w-20 h-20 sm:h-16 2xl:h-20 rounded-lg"></div>
          <div class="bg-black w-20 sm:w-16 2xl:w-20 h-20 sm:h-16 2xl:h-20 rounded-lg"></div>
          <div class="bg-black w-20 sm:w-16 2xl:w-20 h-20 sm:h-16 2xl:h-20 rounded-lg"></div>
