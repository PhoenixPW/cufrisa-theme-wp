...
<article class="flex flex-col sm:flex-row bg-[#DEDEDE] p-5 2xl:p-6 w-full items-center rounded gap-7 sm:gap-0 sm:justify-between sm:my-8">
 ...
 <a href="<?php echo get_template_directory_uri(); ?>/assets/pdf/Semaforo 2023.pdf" target="_blank" class="bg-[#263650] w-11/12 sm:w-4/12 xl:w-3/12 text-center text-white text-xl sm:text-sm md:text-lg lg:text-xl 2xl:text-3xl py-4 2xl:py-6 rounded">
  Descargar
 </a>
</article>
